...
- :star: [算法岗面试求职宝典（包含简历模版、求职攻略、面试经验、面试技巧等通用AIGC面试技巧）](偏算法岗/算法岗面试求职宝典)
...
- :shipit: [数字人基础](偏算法岗/数字人基础)
- :closed_book: [深度学习基础](偏算法岗/深度学习基础)
- :blue_book: [机器学习基础](偏算法岗/机器学习基础)
- :european_castle: [模型部署基础](模型部署基础)
- :stars: [经典模型](偏算法岗/经典模型)
- :snake: [编程基础：Python](偏算法岗/编程基础：Python)
- :bar_chart: [编程基础：C和C++](偏算法岗/编程基础：C和C++)
- :boom: [大厂高频算法题](大厂高频算法题)
- :battery: [数据结构基础](偏算法岗/数据结构基础)
